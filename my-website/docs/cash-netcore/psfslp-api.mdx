...
:::success Notes
For more details visit [BCH APIs](https://api.fullstack.cash/docs/#api-PSF_SLP) page.
:::
...
//inject
private readonly IPsfSlpService _psfSlpService;
```
import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

### 💰Indexer Status.
#### Return SLP indexer status
<Tabs>
  <TabItem value="request" label="Request" default>

```jsx
//Sample Request 🍎
    var indexerStatus = await _psfSlpService!.GetIndexerStatusAsync();
```
...
```
  ...
  <TabItem value="..." label="...">
   ...
   href="https://api.fullstack.cash/docs/#api-PSF_SLP-SLP_indexer_status.">
  Indexer Status.</a>
  </TabItem>
</Tabs>

### 💰List stats for a single slp token.
#### Return list stats for a single slp token.
<Tabs>
  <TabItem value="request" label="Request" default>

```jsx
//Sample Request 🍎
   var tokenStatus = await _psfSlpService!.GetTokenStatusAsync(
...
```
  ...
  <TabItem value="..." label="...">
   🍌 For more information Check out  <a target="_blank" 
   href="https://api.fullstack.cash/docs/#api-PSF_SLP-List_stats_for_a_single_slp_token.">
   List stats for a single slp token.</a>
  </TabItem>
</Tabs>

### 💰SLP balance for address.
#### Return SLP balance for address
<Tabs>
  <TabItem value="request" label="Request" default>

```jsx
//Sample Request 🍎
   var balances = await  _psfSlpService!.GetPsfSlpBalanceAsync(
...
```jsx
//will return PsfSlpBalance: 🍊
   var balances = new PsfSlpBalance
        {
...
```
  ...
  <TabItem value="..." label="...">
   🍌 For more information Check out  <a target="_blank" 
   href="https://api.fullstack.cash/docs/#api-PSF_SLP-SLP_balance_for_address.">
   SLP balance for address.</a>
  </TabItem>
</Tabs>

### 💰SLP transaction data.
#### Return SLP balance for address
<Tabs>
  <TabItem value="request" label="Request" default>
...
```jsx
//Sample Request 🍎
 var balanceInfo = await _psfSlpService!.GetPsfSlpTransactionDataAsync(
...
```
  ...
  <TabItem value="..." label="...">
   🍌 For more information Check out  <a target="_blank" 
   href="https://api.fullstack.cash/docs/#api-PSF_SLP-SLP_transaction_data.">
   SLP transaction data.</a>
  </TabItem>
</Tabs>