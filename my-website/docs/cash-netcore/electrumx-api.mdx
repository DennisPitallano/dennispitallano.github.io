...
```jsx
//will return TransactionDetails: 🍊
...
#### Returns an array of objects with transaction details of an array of TXIDs. Limited to 20 items per request.
...
```jsx
//will return TransactionsDetail: 🍊
                    ...
                    Details = new TransactionDetailData
                    {
                        ...
                        Vout = new List<TransactionDetailVout>
                        {
                            new()
                            {
                                ...
                                ScriptPubKey = new ScriptPubKey
                                {
                                    Asm = "OP_DUP OP_HASH160 3a06fc7cc97302b3f0d60a3a09bdf7c788334471 OP_EQUALVERIFY OP_CHECKSIG",
...
```
  ...
  <TabItem value="..." label="...">
   🍌 For more information Check out  <a target="_blank" 
   href="https://api.fullstack.cash/docs/#api-ElectrumX_/_Fulcrum-Transaction_details_for_an_array_of_TXIDs">
  Get transaction details for an array of TXIDs
</a>
  </TabItem>
</Tabs>
...
```jsx
//will return TransactionHistorySingle: 🍊
...
```
  ...
  <TabItem value="..." label="...">
   🍌 For more information Check out  <a target="_blank" 
   href="https://api.fullstack.cash/docs/#api-ElectrumX_/_Fulcrum-Transaction_history_for_a_single_address">
 Get transaction history for a single address.
</a>
  </TabItem>
</Tabs>

### 💰Get unconfirmed utxos for a single address.
#### Returns an object with unconfirmed UTXOs associated with an address.
...
```jsx
//will return UnconfirmedSingleUtxos: 🍊
...
```
  ...
  <TabItem value="..." label="...">
   🍌 For more information Check out  <a target="_blank" 
   href="https://api.fullstack.cash/docs/#api-ElectrumX_/_Fulcrum-Unconfirmed_UTXOs_for_a_single_address">
Get unconfirmed utxos for a single address.
</a>
  </TabItem>
</Tabs>

### 💰Get unconfirmed utxos for an array of addresses.
#### Returns an array of objects with unconfirmed UTXOs associated with an address. Limited to 20 items per request.
...
```
  ...
  <TabItem value="..." label="...">
   🍌 For more information Check out  <a target="_blank" 
   href="https://api.fullstack.cash/docs/#api-ElectrumX_/_Fulcrum-Unconfirmed_UTXOs_for_an_array_of_addresses">
Get unconfirmed utxos for an array of addresses.
</a>
  </TabItem>
</Tabs>
...
#### Returns an object with UTXOs associated with an address.
...
```
  ...
  <TabItem value="..." label="...">
   🍌 For more information Check out  <a target="_blank" 
   href="https://api.fullstack.cash/docs/#api-ElectrumX_/_Fulcrum-UTXOs_for_a_single_address">
Get utxos for a single address.
</a>
  </TabItem>
</Tabs>
...
#### Returns an array of objects with UTXOs associated with an address. Limited to 20 items per request.
...
```
  ...
  <TabItem value="..." label="...">
   🍌 For more information Check out  <a target="_blank" 
   href="https://api.fullstack.cash/docs/#api-ElectrumX_/_Fulcrum-UTXOs_for_an_array_of_addresses">
Get utxos for an array of addresses.
</a>
  </TabItem>
</Tabs>